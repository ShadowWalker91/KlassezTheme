        	...
        	<div class="row">
            	<div class="col-md-12">
                  ...
                  <?php if ($user_role== TUTOR)
                    {
                    echo '<a href="#">Change to Student</a>';
                  }elseif ($user_role== STUDENT){
                    echo '<a href="#">Change to Tutor</a>';
                }
                  ...
                  ?>
                    <div class="nav-tabs-profile">
                        ...
                        <ul class="nav nav-tabs responsive" role="tablist" id="myTab">
                            ...
                            <?php if(fre_share_role() || $user_role == TUTOR){ ?>
                            <li>
                	...
                	<div class="tab-content-profile">
                        ...
                        <div class="tab-content block-profiles responsive">
                            ...
                            <div class="tab-pane fade" id="tab_project_details">
                                ...
                                if(fre_share_role() || $user_role == TUTOR) {
                                    // tutor bids history and reviews
                	...
                	<div class="setting-profile-wrapper <?php echo $user_role; ?>">
                        ...
                        <div class="form-group">
                            <span class="text-small">
                                <?php _e('Select "Yes" to display a "Hire me" button on your profile allowing students and parents to contact you.', ET_DOMAIN) ?>
                            </span>
                        </div>
                        <?php }
                        ...
                        <ul class="list-setting">
                            ...
                            <li>
                                  <a href="#" class="switch_profile">
                                      <i class="fa fa-user"></i>
                                      <?php _e("Switch to Tutor Profile", ET_DOMAIN) ?>
                                  </a>
                              </li>
                            <?php }
                            if(fre_share_role() || $user_role == TUTOR ) { ?>
                            <li>
                                  <a href="#" class="switch_profile">
                                      <i class="fa fa-user"></i>
                                      <?php _e("Switch to Student Profile", ET_DOMAIN) ?>
                                  </a>
                              </li><?php }?>
                        	<li>
...
jQuery(document).ready(function($){
  jQuery('.switch_profile').click(function(e){
    e.preventDefault();
      jQuery.ajax({
               type : "GET",
               dataType : "json",
               url : ae_globals.ajaxURL,
               data : {action: "switch_profile"},
