            ...
            if ($('.sign-up-switch').length > 0) {
                ...
                clickCheckbox.onchange = function(event) {
                    ...
                    if (clickCheckbox.checked) {
                        roles_array =  array(
                                          'role'         => 'tutor', // Set the role you want to search for here
                                          'role__not_in' => 'student');
                        roleInput.val($roles_array);                                          //roleInput.val("tutor");
                      ...
                      /*roles_array =  array(
                                        'role'         => 'student', // Set the role you want to search for here
                                        'role__not_in' => 'tutor');*/
                      roleInput.val('student');
                        //roleInput.val("student");
