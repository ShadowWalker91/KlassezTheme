<div class="modal fade" id="modal_register">
	<input type="hidden" value="<?php _e("Teacher", ET_DOMAIN); ?>" class="work-text" name="worktext" />
	<input type="hidden" value="<?php _e("Student", ET_DOMAIN); ?>" class="hire-text" name="hiretext" />
				...
				<form role="form" id="signup_form" class="auth-form signup_form">
                	<p class="user-type">
                		<?php _e("What are you looking for?", ET_DOMAIN) ?>
                            ...
                            <input type="checkbox" class="sign-up-switch" name="modal-check" value="student"/>
                            <span class="user-role text hire">
                                <?php _e("Student", ET_DOMAIN); ?>
                            </span>
                	</p>
